...
video_path=f'ML/tempo/data/test_img/{fitness}.mp4'       # input video path
out_video_dir = f'ML/tempo/Result/{fitness}'                        # output video dir
sample_csv_path = 'ML/tempo/data/fitness_poses_csvs_out' # Landmark Info of fitness poses
