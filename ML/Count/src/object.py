...
class PoseClassificationVisualizer(object):
  ...
  def __call__(self,
    ...
    #                   int(output_height * self._plot_location_y))) # pastes on top-left corner
    ...
    for classification_history in [self._pose_classification_history,
      ...
      for classification in classification_history:
        if classification is None:
          ...
          y.append(0)
      plt.plot(y, linewidth=7, label = 'y')
    ...
    for pose_class_name in self._pose_class_names:
      ...
      with open(csv_out_path, 'w') as csv_out_file:
        ...
        for image_name in tqdm.tqdm(image_names):
          # Load image.
          #print(os.path.join(images_in_folder, image_name))
  ...
  def remove_outliers(self, outliers):
    ...
    for outlier in outliers:
      ...
      try:
        ...
        print('Failed to remove image: ', image_path)
